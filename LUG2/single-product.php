<?php    
    ...
    $name_of_product = CleanInputs($_GET["proudct_name"]);

    
    $ram_sql = "select ram.*, products.product_name, products.product_price, products.product_condition, products.product_image, suppliers.supplier_name from ram join products on $id = products.id join suppliers on products.supplier_id = suppliers.id";
    ...
    array_push($_SESSION["product_info"], array($_POST["product_id"] => $_POST["quantity"]));
                            ...
                            <div class="product-details-images slider-navigation-1">
                                <div class="lg-image">
                                    <a class="popup-img venobox vbox-item"
                                        href="<?php echo "./Blog/Admins/Pages/product/" . $ram_fetch["product_image"]; ?>"
                                        data-gall="myGallery">
                                        <img src="<?php echo "./Blog/Admins/Pages/product/" . $ram_fetch["product_image"]; ?>"
                                            alt="product image">
                                    </a>
                                </div>
                                <div class="lg-image">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="product-details-view-content pt-60">
                            <div class="product-info">
                                <h2><?php echo  $ram_fetch["product_name"]; ?></h2>
                                <span class="product-details-ref">Supplier:
                                    <?php echo $ram_fetch["supplier_name"]; ?></span>
                                ...
                                <div class="price-box pt-20">
                                    <span class="new-price new-price-2"><?php echo $ram_fetch["product_price"]; ?>
                                        L.E</span>
                                </div>
                                <div class="product-desc">
                                    <p>
                                        <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corrupti ratione
                                            asperiores inventore? Odio facere nobis exercitationem incidunt non? Qui
                                            dignissimos, dolor ullam veritatis unde suscipit amet harum quae libero!
                                            Voluptatum!
                                        </span>
                                    </p>
                                </div>
                                <div class="single-add-to-cart">
                                    <form method="post" action="<?php $_SESSION["PHP_SELF"]; ?>" class="cart-quantity">
                                        <div class="quantity">
                ...
                <div class="tab-content">
                    <div id="product-details" class="tab-pane" role="tabpanel">
                        <div class="product-details-manufacturer">
                            <p> Product Condition: <?php  echo ' ' . ucwords($ram_fetch["product_condition"]);?> </p>
                            <p> Model Number: <?php echo ' ' . $ram_fetch["model_number"];?> </p>
                            <p> Memory Size: <?php echo ' ' . $ram_fetch["memory_size"];?> </p>
                            <p> Memory Speed: <?php echo ' ' . $ram_fetch["memory_speed"];?> </p>
                            <p> Type of RAM: <?php echo ' ' . strtoupper($ram_fetch["product_condition"]);?> </p>
                            <p> Compatible With: <?php echo ' ' . ucwords($ram_fetch["compatible_with"]);?> </p>
                            <p> Number of Pins: <?php echo ' ' . $ram_fetch["number_of_pins"];?></p>
                            <p> Kit Includes: <?php echo ' ' . ucwords($ram_fetch["kit_includes"]);?></p>
                                    ...
                                    <div class="single-product-wrap">
                                        ...
                                        <div class="product_desc">
                                            <div class="product_desc_info">
                                                ...
                                                <h4><a class="product_name" href="single-product.php">Accusantium
                                                        dolorem1</a></h4>
                                                <div class="price-box">
